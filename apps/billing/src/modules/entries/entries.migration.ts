import type { BillingMigration } from "../../migrations/types.js";

export const tenantEntryDocumentsMigration: BillingMigration = {
...
export const tenantEntryComplianceMigration: BillingMigration = {
