...
export const exportSalesEntryLineSchema = z.object({
...
export const exportSalesAllocationSchema = z.object({
...
export const exportSalesEntrySchema = z.object({
  entryId: z.string(),
  entryType: z.literal("exportSales"),
  documentNo: z.string(),
  ...
  createdAt: z.string(),
  updatedAt: z.string(),
  lines: z.array(exportSalesEntryLineSchema),
  allocations: z.array(exportSalesAllocationSchema).default([]),
...
export const exportSalesEntriesSchema = z.array(exportSalesEntrySchema);