...
export const quotationEntryLineSchema = z.object({
...
export const quotationAllocationSchema = z.object({
...
export const quotationEntrySchema = z.object({
  entryId: z.string(),
  entryType: z.literal("quotation"),
  documentNo: z.string(),
  ...
  createdAt: z.string(),
  updatedAt: z.string(),
  lines: z.array(quotationEntryLineSchema),
  allocations: z.array(quotationAllocationSchema).default([]),
...
export const quotationEntriesSchema = z.array(quotationEntrySchema);