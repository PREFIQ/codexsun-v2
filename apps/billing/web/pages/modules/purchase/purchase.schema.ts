...
export const purchaseEntryLineSchema = z.object({
...
export const purchaseAllocationSchema = z.object({
...
export const purchaseEntrySchema = z.object({
  ...
  createdAt: z.string(),
  updatedAt: z.string(),
  lines: z.array(purchaseEntryLineSchema),
  allocations: z.array(purchaseAllocationSchema).default([]),
