...
test.describe("Billing Receipt module", () => {
  test("opens Receipt list through the module-owned page", async ({ page }) => {
    const browserErrors: string[] = [];
    collectBrowserErrors(page, browserErrors);

    await loginAsTenant(page);
    await page.goto("/tenant/entries/receipt");
    ...
    await expect(page.getByText("Record customer receipts and allocations.")).toBeVisible();
